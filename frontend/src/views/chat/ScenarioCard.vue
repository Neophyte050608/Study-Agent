    ...
    <div class="p-6 space-y-5">
      ...
      <div v-else class="space-y-4">
        ...
        <div class="rounded-xl border border-emerald-200 dark:border-emerald-900 bg-emerald-50/70 dark:bg-emerald-950/20 p-4">
          ...
          <div
            class="markdown-body text-[14px] leading-relaxed text-slate-700 dark:text-slate-200"
            v-html="renderMarkdown(payload.referenceAnswer || '暂无参考答案')"
          ></div>
        </div>
        ...
        <div v-if="payload.nextHint" class="rounded-xl border border-amber-200 dark:border-amber-900 bg-amber-50/70 dark:bg-amber-950/20 p-4">
          ...
          <div
            class="markdown-body text-[14px] leading-relaxed text-slate-700 dark:text-slate-200"
            v-html="renderMarkdown(payload.nextHint)"
          ></div>
        </div>
...
import { nextScenarioCard, submitScenarioCard } from '../../api/coding'
