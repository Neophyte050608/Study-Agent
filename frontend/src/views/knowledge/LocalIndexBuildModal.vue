<template>
  <div class="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
    <div class="bg-surface-raised rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden flex flex-col transform transition-all">
      ...
      <div class="p-6 space-y-5">
        <div class="space-y-2">
          ...
          <input
            ...
            type="text"
            class="w-full bg-surface-field border border-slate-200 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all outline-none"
      ...
      <div class="px-6 py-4 border-t border-slate-100 bg-slate-50/80 flex justify-end gap-3">
        ...
        <button @click="handleBuild" class="px-6 py-2.5 bg-brand text-white text-sm font-bold rounded-lg hover:bg-brand-hover transition-all flex items-center gap-2 disabled:opacity-60 shadow-sm" :disabled="loading">
