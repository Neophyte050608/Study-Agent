package io.github.imzmq.interview.platform.config.agent;

import io.github.imzmq.interview.agent.a2a.A2ABus;
import io.github.imzmq.interview.agent.a2a.InMemoryA2ABus;
...
public class A2ABusConfig {
    ...
    public io.github.imzmq.interview.agent.a2a.InMemoryA2ABus inMemoryA2ABus(io.github.imzmq.interview.agent.a2a.A2AIdempotencyStore idempotencyStore) {
        return new io.github.imzmq.interview.agent.a2a.InMemoryA2ABus(idempotencyStore);
    }
