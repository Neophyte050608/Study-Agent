...
public class ClarificationResolver {
    ...
    public void captureState(String sessionId, TaskResponse response, io.github.imzmq.interview.integration.im.application.service.ImConversationStore conversationStore) {
