package io.github.imzmq.interview.knowledge.internal.ingestion.pipeline;
...
public class IngestionStageNodeRegistry {
     ...
     *
     * <p>该阶段会调用上下文中的 syncSupplier 执行 {@link io.github.imzmq.interview.knowledge.internal.ingestion.application.IngestionService}
